...
import com.springboard.springboard.config.JpaConfig;
...
class JpaRepositoryTest {
    ...
    void givenTestData_whenInserting_thenWorksFine() {
        ...
        UserAccount userAccount = userAccountRepository.save(UserAccount.of("asher27", "pw", null, null, null));
    ...
    void givenTestData_whenUpdating_thenWorksFine() {
        //Given
        Article article = articleRepository.findById(30L).orElseThrow();
