...
import com.springboard.springboard.config.TestSecurityConfig;
...
import com.springboard.springboard.dto.ArticleDto;
...
import com.springboard.springboard.util.FormDataEncoder;
...
class ArticleControllerTest {
    ...
    @DisplayName("[view][GET] 게시글 페이지 - 정상 호출, 인증 없을 땐 로그인 페이지로 이동")
    @Test
    public void givenNothing_whenRequestingArticleView_thenRedirectsToLoginPate() throws Exception {
        // Given
        Long articleId = 1L;
